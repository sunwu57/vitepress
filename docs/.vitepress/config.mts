...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      message: `
      `,
      copyright: ` <div style="padding: 10px; border-radius: 8px; border: 1px solid #d1e9ff; display: flex; align-items: flex-start;">
    ...
    </div><div style="text-align: center; font-size: 14px;">
