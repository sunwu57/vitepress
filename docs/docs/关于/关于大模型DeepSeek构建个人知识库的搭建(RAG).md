...
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/36912032c6fc3cde9db99ae8d89da0e6.png)



另外建议不要安装在C盘

![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/12f597b200f028c70cff894bb4f16bf2.png)
...
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/c95fb761ec8921cea756a80167f6cff3.png)

通过浏览器访问本地11434端口，出现`Ollama is running`就说明成功了

![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/45014ae07cd0f925fdb1853267d587bb.png)
...
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/bde7ec2ec3afff990d45d75dc01804a1.png)![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/91747b1000c3cca3913d4096ac949a2c.png)

### 添加大模型
1. 进入`dify`的设置  
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/e0721e92d2a7f27291276c02748be429.png)
2. 这里的配置  
...
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/46ca8857abbc275c69eb6fdfc71f2b75.png)

### 将准备好的文档进行投喂，建立知识库
1. 将准备好的文件拖进来就行

![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/dd23cb5cd0acd638ceaeb616cbd5a0ee.png)

剩下的默认就行，保存并处理。

![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/b5e8ab05640a3bc7323ecd98e26df5e0.png)

这样就建立了一个知识库，知识库有一个文档。后续有需要可以自行添加。

![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/ff5ecea733087803e0e28fb0339d9a10.png)![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/cbb5d334957d2008d50fa9fdecfa5cbf.png)<font style="color:rgb(51, 51, 51);">向量数据库是一种用于存储和查询高维向量数据的数据库，其核心功能是提供高效的相似度搜索，使得查询向量能够找到与之最接近的向量。相比传统</font>[<font style="color:rgb(0, 82, 217);">关系型数据库</font>](https://cloud.tencent.com/product/tencentdb-catalog?from_column=20065&from=20065)<font style="color:rgb(51, 51, 51);">（如 </font><font style="color:rgb(0, 82, 217);">MySQL</font><font style="color:rgb(51, 51, 51);">、</font><font style="color:rgb(0, 82, 217);">PostgreSQL</font><font style="color:rgb(51, 51, 51);">），向量数据库更适合存储和检索非</font><font style="color:rgb(0, 82, 217);">结构化数据</font><font style="color:rgb(51, 51, 51);">，如文本、图像、音频等。</font>
...
## 创建基于知识库的聊天机器人并发布
1. 创建空白应用  
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/b02fc0632d05a0bc2fd4bbc7d22f1cb5.png)
2. 初学者用默认的第一个就行，设置名称，创建  
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/60ac546eea1d610485d98a82bf94ea07.png)
...
4.   
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/4e308004c31af793d0fc3ac7e1f9c3a9.png)
5. 可以发现一本正经的胡扯  
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/53c5faceacd7f941d2342b24a2978cf7.png)
6. 这时我们加入知识库  
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/61f1cc214a3fe1edaa40505c48c6faf8.png)  
再问同样的东西，这次发现就靠谱多了，回答的是分钟  
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/0459b23e7c4341895d80a8d45c506cbf.png)
7. 点击发布，这样我们在探索中就会多一个应用  
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/2bf0eb2a1569bddd460f76699f0d7c0c.png)  
如果想让其他人也访问，点击右上角运行即可  
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/98d1c8dbc2c8151bc80b7da18058f205.png)  
会自动打开一个新的窗口，这个窗口是所有人都可以访问的，不需要登录也可以访问。记得将ip换一下。至此我们就构建了一个基于个人知识库的大模型`应用聊天机器人`。  
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/66f43d4367ba7fe19f984ab0c3f85095.png)
...
这里面是ollama整理的一些模型  
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/173ea1ba492ab9fd2a811870fa77e1d2.png)
2. 如何查看自己电脑的显存？

任务管理器->性能->GPU 0->专用就是自己的显存大小，我的是12GB。

![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/27cd2d644b09cf1d7931ddd67b802d66.png)
...
## 漏洞利用
### ollama未授权
1. 一般来说，访问默认端口11434。提示`Ollama is running` 可能存在漏洞![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/a287e1f802384afdb7c386637e0e03f5.png)
2. 进一步验证，GET请求利用接口地址/api/tags。寻找合适的模型就可以了，这里看到一个32b的  
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/8e28c88d8d03d9d7bf5012233288a835.png)
