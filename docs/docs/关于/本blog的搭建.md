...
+ `<font style="color:rgb(199, 37, 78);background-color:rgb(249, 242, 244);">docs</font>`<font style="color:rgba(0, 0, 0, 0.75);"> </font><font style="color:rgba(0, 0, 0, 0.75);">文件夹：</font>`<font style="color:rgb(199, 37, 78);background-color:rgb(249, 242, 244);">VitePress</font>`<font style="color:rgba(0, 0, 0, 0.75);"> </font><font style="color:rgba(0, 0, 0, 0.75);">项目的</font>**<font style="color:rgba(0, 0, 0, 0.75);">根目录</font>**
