...
```php
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/img/20250326134620283.png)<?php
...
![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/img/20250326134620284.png)

```plain
/admin/cert_download.php?file=test.txt&certfile=cert_download.php
```

![](https://raw.githubusercontent.com/sunwu57/tuchuang/main/img/20250326140655400.png)